...
\begin{figure}[!htbp]
\begin{center}
%        \includegraphics[width=0.49\linewidth,angle=0]{figures/fL1_vs_fa2_Real.pdf}
...
%        \includegraphics[width=0.49\linewidth,angle=0]{figures/fL1_vs_fa2_Profile.pdf}
...
\begin{figure}[!htbp]
  \begin{center} 
%    \includegraphics[width=0.49\linewidth]{figures/flambda1_combine_ww.pdf}
    ...
    \caption{ Expected and observed likelihood scans for effective
      ...
      %% Measurements are shown for each channel separately and two types
      %% of combination are present: using $a_1^{\PW\PW} = a_1$ (red) and
