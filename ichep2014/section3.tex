...
%% parameter of 0.5, and they are used to categorize events to enhance
...
For the $\chanHZZ$ decay, events are selected with at least four
...
One of the approaches pursued in this channels is to parameterize the
